...
// this color scheme substitutes #f2f2f2 with #828282, and darker are then #626262, slightly darker still #525252
  ...
  if (location.href.indexOf('torn.com') !== -1) {
    GM_addStyle('' +
      ...
      '.d .preferences-container #prefs-tab-menu .headers li { background: linear-gradient(to bottom,#dfdfdf 0,#525252 100%) !important; }' +
      '.d .preferences-container #prefs-tab-menu .headers li:hover { background: linear-gradient(to bottom,#626262 0,#424242 100%) !important; }' +
      '.d .preferences-container #prefs-tab-menu .headers li.delimiter { background: #626262 none !important; }' +
      '.d .preferences-container #prefs-tab-menu .headers li.ui-state-active { background: linear-gradient(to bottom,#deecef 0,#c6d3d7 100%) !important; }' +
      '.d .info-msg .msg { background: linear-gradient(to bottom,#dfdfdf 0,#525252 100%) !important; }' +
      '.d .users-list>li.expanded { background: #828282 !important; }' +
...
//    '.d .stock-main-wrap .stock-list .item .stock-tabs>li.ui-tabs-active, .d .sortable-list .latest-messages .list-cont-bg>li.new ' +
      '.d .white-grad, .d .white-grad-tabs>li { background: linear-gradient(to bottom,#626262 0,#525252 100%) !important; }' +
      '.d .white-grad-tabs li.ui-tabs-active, .d .white-grad-tabs>li:hover { background: linear-gradient(to bottom,#828282 0,#626262 100%) !important; }' +
// factions
...
// items
      ...
      '.d .travel-agency-market .item-wrap { background-color: #828282 !important; }' +
...
// delimiters
      ...
      '.d .l-delimiter { background: linear-gradient(to right,#828282 0,rgba(242,242,242,0) 100%) !important; }' +
      '.d .r-delimiter { background: linear-gradient(to right,rgba(242,242,242,0) 0,#828282 100%) !important; }' +
      '.d .preferences-container .l-delimiter { background: linear-gradient(to right,#626262 0,rgba(242,242,242,0) 100%) !important; }' +
      '.d .preferences-container .r-delimiter { background: linear-gradient(to right,rgba(242,242,242,0) 0,#626262 100%) !important; }' +
